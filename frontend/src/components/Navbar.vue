    ...
    <header class="flex justify-between items-center p-3 h-14 shadow bg-white">
      ...
      <Menu as="div" class="relative inline-block text-left">
        <MenuButton class="flex items-center">
          <img src="https://c1.klipartz.com/pngpicture/57/433/sticker-png-user-profile-circle-user-account-data-login-symbol-blackandwhite-line-art.png" class="rounded-full w-8 mr-2">
